...
int main(int, char**) {
    ...
    samplers.push_back(std::make_unique<TextureSampler>(std::make_unique<Image>("../resources/flower.bmp")));
    samplers.push_back(std::make_unique<TextureSampler>(std::make_unique<Image>("../resources/metal.bmp")));
    samplers.push_back(std::make_unique<TextureSampler>(std::make_unique<Image>("../resources/carbon.bmp")));
